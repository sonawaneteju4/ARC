    ...
    <div className="mt-16">
      ...
      <div className="flex lg:flex-row flex-col">
        ...
        <div className="basis-1/4 m-2 items-center">
          <img className="h-40 block ml-auto mr-auto imgShadow"  src="/image/orders.png" alt="" />
          <p className="text-center text-3xl font-bold">
          Orders
          </p>
          </div>
        <div className="basis-1/4 m-2"><img className="h-40 block ml-auto mr-auto imgShadow"  src="/image/qt.png" alt="" />
          <p className="text-center text-3xl font-bold">
          Quote Responce
          </p></div>
        <div className="basis-1/4 m-2"></div>
      </div>
      <div></div>
    </div>
  );
