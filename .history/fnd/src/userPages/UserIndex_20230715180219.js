    ...
    <div className="mt-16">
      ...
      <div className="flex lg:flex-row flex-col">
        <div className="basis-1/4 m-2  bg-white rounded-2xl">
          <img
            src="/image/admin.png"
            className="h-40 block drop-shadow-2xl shadow-black ml-auto mr-auto "
          ></img>
        ...
        <div className="basis-1/4 m-2 items-center drop-shadow-2xl shadow-black">
          <img className="h-40 block ml-auto mr-auto drop-shadow-[0_35px_35px_rgba(10,10,10,10.25)]" src="/image/orders.png" alt="" />
