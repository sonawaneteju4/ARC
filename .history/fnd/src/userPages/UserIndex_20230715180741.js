...
const Index = () => {
  ...
  const imageStyle = {
    filter: boxShadow("5px 5px 5px Red")  // Adjust the values to customize the shadow
  };
    ...
    <div className="mt-16">
      ...
      <div className="flex lg:flex-row flex-col">
        ...
        <div className="basis-1/4 m-2 items-center">
          <img className="h-40 block ml-auto mr-auto" '0px 2px 4px rgba(0, 0, 0, 0.2)', src="/image/orders.png" alt="" />
