    ...
    <>
      <div className="mt-16 min-h-screen divide-y-2">
        ...
        <div className="flex lg:flex-row md:flex-col max-sm:flex-col">
          {setCartIsEmpty<div className="basis-2/3 p-5 h-[75vh]  lg:scrollbar-thin scrollbar-thumb-sky-600 scrollbar-track-sky-300 overflow-y-scroll dark:scrollbar-thumb-blue-100 dark:scrollbar-track-gray-700 scrollbar-track-rounded-full">
            {fornew ? (
