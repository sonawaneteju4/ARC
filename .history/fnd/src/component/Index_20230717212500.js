...
const Index = () => {
  ...
  const slides = [
    { image: '/image/demo.jpg', caption: 'Car Wraping' },
    { image: 'image/bikee.jpg', caption: 'Bike Wraping' },
    { image: 'image/car2.jpg', caption: 'Helmet Wraping' },
    { image: '/image/demo.jpg', caption: 'Mobile Wraping' },
    { image: 'image/car.jpg', caption: 'Alloy Painting' },
    { image: 'image/car2.jpg', caption: 'Tuning' },
    { image: 'image/car2.jpg', caption: 'PPF And Detailing' },
    { image: 'image/car2.jpg', caption: 'Modification' },
  ];
  useEffect(() => {
    setTimeout(() => {
      setIsLoading(false);
