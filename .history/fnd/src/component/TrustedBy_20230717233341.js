    ...
    <div>
      <section className=" text-gray-800 text-center">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 items-center">
          ...
          <div className="mb-12 lg:mb-0 text-center font-extrabold  lg:text-5xl sm:text-3xl">
            {/* <img
              src="https://mdbootstrap.com/img/Photos/new-templates/landing-page/3.png"
              className="img-fluid  px-6 md:px-12"
              alt="Nike - logo"
            /> */}
            <span className="md:px-12 px-6 ">GARAVE MOTAR</span>
          </div>
          <div className="mb-12 lg:mb-0 font-extrabold lg:text-5xl sm:text-3xl">
            <span className="md:px-12 px-6">100KMph</span>
          </div>
        </div>
      </section>
    </div>
