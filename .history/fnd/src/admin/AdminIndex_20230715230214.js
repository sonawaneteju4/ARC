  ...
  return (
    <div>
      ...
      <div className="pt-16 flex flex-row">
        <div className="basis-1/4 bg-slate-500 p-5 m-5 text-center">New Orders</div>
        <div className="basis-1/4 bg-slate-500 p-5 m-5 text-center">Coustomers</div>
        <div className="basis-1/4 bg-slate-500 p-5 m-5 text-center">Products</div>
        <div className="basis-1/4 bg-slate-500 p-5 m-5 text-center">Quotes</div>
      </div>
