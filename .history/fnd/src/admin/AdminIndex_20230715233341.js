      ...
      <div className="pt-16 flex flex-row">
        ...
        <div className="basis-1/4 p-5 m-5 flex">
          ...
          <div className="pl-10">
            ...
            <p className="py-1 font-bold">Remove  Product (5)</p>
            <p className="py-1 font-bold">Sales Products(5)</p>
            <p className="py-1 font-bold">Inventory (102)</p>
            <p className="py-1 font-bold">Product By Sells(3)</p>
            <p className="py-1 font-bold">Products with Less Sells(2)</p>
            <p className="py-1 font-bold">All Orders(122)</p>
          </div>
        </div>
