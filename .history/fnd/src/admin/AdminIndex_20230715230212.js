  ...
  return (
    <div>
      ...
      <div className="pt-16 flex flex-row">
        <div className="basis-1/4 bg-slate-500 p-5 m-5 text">New Orders</div>
        <div className="basis-1/4 bg-slate-500 p-5 m-5 text">Coustomers</div>
        <div className="basis-1/4 bg-slate-500 p-5 m-5 text">Products</div>
        <div className="basis-1/4 bg-slate-500 p-5 m-5 text">Quotes</div>
      </div>
