  ...
  return (
    <div>
      ...
      <div className="pt-16 flex flex-row">
        <div className="basis-1/4 justify-center">New Orders</div>
        <div className="basis-1/4 justify-center">Coustomers</div>
        <div className="basis-1/4 justify-center">Products</div>
        <div className="basis-1/4 justify-center">Quotes</div>
      </div>
