  ...
  return (
    <div>
      ...
      <div className="pt-16 flex flex-row">
        <div className="basis-1/4 bg-slate-500 p-5 m-5 text-center h-">New Orders</div>
        <div className="basis-1/4 bg-slate-500 p-5 m-5 text-center h-">Coustomers</div>
        <div className="basis-1/4 bg-slate-500 p-5 m-5 text-center h-">Products</div>
        <div className="basis-1/4 bg-slate-500 p-5 m-5 text-center h-">Quotes</div>
      </div>
