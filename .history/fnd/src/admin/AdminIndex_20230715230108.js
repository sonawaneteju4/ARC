  ...
  return (
    <div>
      ...
      <div className="pt-16 flex flex-row">
        <div className="basis-1/4 ju">New Orders</div>
        <div className="basis-1/4 ju">Coustomers</div>
        <div className="basis-1/4 ju">Products</div>
        <div className="basis-1/4 ju">Quotes</div>
      </div>
