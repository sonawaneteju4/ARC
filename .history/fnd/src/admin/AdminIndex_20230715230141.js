  ...
  return (
    <div>
      ...
      <div className="pt-16 flex flex-row">
        <div className="basis-1/4 bg-slate-500 p-5">New Orders</div>
        <div className="basis-1/4 bg-slate-500 p-5">Coustomers</div>
        <div className="basis-1/4 bg-slate-500 p-5">Products</div>
        <div className="basis-1/4 bg-slate-500 p-5">Quotes</div>
      </div>
