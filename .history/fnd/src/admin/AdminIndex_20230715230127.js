  ...
  return (
    <div>
      ...
      <div className="pt-16 flex flex-row">
        <div className="basis-1/4 bg-">New Orders</div>
        <div className="basis-1/4 bg-">Coustomers</div>
        <div className="basis-1/4 bg-">Products</div>
        <div className="basis-1/4 bg-">Quotes</div>
      </div>
