  ...
  return (
    <div>
      ...
      <div className="pt-16 flex flex-row">
        <div className="basis-1/4 bg-slate-500 p-5 m-5 text-center h-60">New Orders</div>
        <div className="basis-1/4 bg-slate-500 p-5 m-5 text-center h-60">Coustomers</div>
        <div className="basis-1/4 bg-slate-500 p-5 m-5 text-center h-60">Products</div>
        <div className="basis-1/4 bg-slate-500 p-5 m-5 text-center h-60">Quotes</div>
      </div>
