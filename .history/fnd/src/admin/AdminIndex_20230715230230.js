  ...
  return (
    <div>
      ...
      <div className="pt-16 flex flex-row">
        <div className="basis-1/4 bg-slate-500 p-5 m-5 text-center h-40">New Orders</div>
        <div className="basis-1/4 bg-slate-500 p-5 m-5 text-center h-40">Coustomers</div>
        <div className="basis-1/4 bg-slate-500 p-5 m-5 text-center h-40">Products</div>
        <div className="basis-1/4 bg-slate-500 p-5 m-5 text-center h-40">Quotes</div>
      </div>
