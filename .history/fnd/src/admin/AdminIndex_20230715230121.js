  ...
  return (
    <div>
      ...
      <div className="pt-16 flex flex-row">
        <div className="basis-1/4 bg-white">New Orders</div>
        <div className="basis-1/4 bg-white">Coustomers</div>
        <div className="basis-1/4 bg-white">Products</div>
        <div className="basis-1/4 bg-white">Quotes</div>
      </div>
