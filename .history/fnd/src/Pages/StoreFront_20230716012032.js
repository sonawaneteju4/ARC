  ...
  return (
    <section className="">
      <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
        ...
        At AR CUSTOMS, we specialize in car, bike, and helmet wrapping, as well as customizations and modifications. Our team of experts is dedicated to providing top-notch services to enhance the aesthetics and performance of your vehicles and accessories.
        </p>
