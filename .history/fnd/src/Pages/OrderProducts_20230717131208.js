    ...
    <>
      {product && (
        <>
          ...
          <div className="basis-1/5 text-end">Price: {price}</div>
          <div className="basis-1/5 text-end">Quantity: {quantity}</div>
          <div className="basis-1/5 text-end">Total : {total}</div>
        </>
      )}
    </>
  );
