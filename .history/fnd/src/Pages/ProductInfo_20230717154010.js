  ...
  const handleAddToCart = () => {
    if (sessionStorage.getItem("token")) {
      if (selectedBrand === null || selectedDevice === null) {
        ...
        }else{          seterrMsgbrand(selectedBrand ? null : "Select Brand");
        }
        return;
      }
      setshowLogin(false);
        ...
        <div className="flex lg:flex-row flex-col">
          ...
          <div className="basis-1/3  lg:mr-5 mx-5 ">
            ...
            <div className="flex justify-between">
              <div>
                <small className="text-red-400 mt-2 font-bold">
                  {errMsgbrand}
                </small>
              </div>
              <div>
                <small className="text-red-400 mt-2 font-bold">{errMsg}</small>
              </div>
            </div>
