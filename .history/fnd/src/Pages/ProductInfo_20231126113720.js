        ...
        <div className="flex lg:flex-row flex-col">
          <div className="basis-8/12">
            <div className="">
              ...
              <div className="flex justify-center">
                {Array.isArray(link) &&
                  link.map((item, index) => (
                    <Tilt options={defaultOptions} key={index} className="h-40 w-40 m-3">
                      <img
                        src={item}
          ...
          <div className="basis-1/3  lg:mr-5 mx-5 ">
            ...
            <div className=" lg:flex flex-row sm:block">
              ...
              <div className="basis-1/2 pl-2">
                <small className="text-red-500 mt-2  font-extrabold ">{errMsg}</small>
              </div>
            </div>
            ...
            <>
              ...
              >
                ...
                <div className="fixed top-0 left-0 right-0 bottom-0 z-50 flex items-center justify-center">
                  <Tilt options={defaultOptions} className="bg-white rounded-lg overflow-hidden shadow-lg">
                    <img
                      src={image}
                      alt="modal"
