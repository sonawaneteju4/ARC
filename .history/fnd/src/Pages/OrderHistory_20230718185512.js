    ...
    <div className="mt-16">
      ...
      <div className=" mx-5">
        ...
        {orderHistory.map((order) => (
          <div
            className="m-10 flex my-2 justify-center odd:bg-white even:bg-white/50 rounded-xl"
            key={order._id}
          >
          <AccordData key={order._id} title={title} content={content} />
            ...
            <div className="p-5 m-5  bg-teal-100/30 rounded-xl  h-52 ">
              <NavLink to={`/order/${order._id}`} orderPlace={true}>
                <div>
