...
const OrderAccord = ({ oId, oderDate, gTotal, status, items, address }) => {
  ...
  return (
    <div className="m-2">
      ...
      {isActive && (
        <div style={{backgroundColor: "lightgray"}} className="px-3 bg-white/80 items-center odd:bg-white even:bg-white/50 ">
          <NavLink to={`/order/${oId}`} orderPlace={true}>
            ...
            <div className="flex flex-row">
              ...
              <div className="py-5 px-5 m-3 bg-white/80 rounded-xl">
                <p>Address:</p>
