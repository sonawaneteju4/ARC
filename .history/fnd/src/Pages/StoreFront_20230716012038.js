    ...
    <section className="">
      <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
        ...
        <p className="mb-8 text-base font-mono text-gray-500 lg:text-base sm:px-16 xl:px-48 dark:text-gray-400">
         AR CUSTOMS, we specialize in car, bike, and helmet wrapping, as well as customizations and modifications. Our team of experts is dedicated to providing top-notch services to enhance the aesthetics and performance of your vehicles and accessories.
        </p>
