...
const   SearchButton = ({onChange}) => {
  return (
    ...
    <input type="search" name="q" className="py-1 lg:py-2 text-xs lg:text-sm  text-black border-2 border-gray-700 pl-5 r" placeholder="Search..." onChange={onChange}  autoComplete="off" />
