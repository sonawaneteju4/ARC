  ...
  return (
    <section className="">
      <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
        ...
        <h1 style={{ fontFamily: "var(--art-font)" }} className="mb-4 tracking-wide text-3xl font-extrabold  leading-none md:text-3xl lg:text-5xl bg-clip-text text-transparent bg-gradient-to-r from-gray-400 via-neutral-800 to-sky-400">
