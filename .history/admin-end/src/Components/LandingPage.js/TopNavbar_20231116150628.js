    ...
    <div>
      <div className=" w-screen h-16 bg-slate-100 flex justify-between">
        <div className=" flex items-center">
          ...
          <p className="pl-5 text-white">Service</p>
          <p className="pl-5 text-white">Products</p>
          <p className="pl-5 text-white">Gallery</p>
          <p className="pl-5 text-white">Quotations</p>
        </div>
