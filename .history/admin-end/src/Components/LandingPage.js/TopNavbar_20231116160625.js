    ...
    <div>
      <div className=" w-screen h-16 bg-gray-200 flex justify-between">
        <div className=" flex items-center">
          ...
          <NavLink to="/dashboard" activeClassName="active" className="pl-5 flex">
            <RxDashboard className="mt-1 mx-1" />
            Dashboard
          </NavLink>
          <NavLink to="/service" activeClassName="active" className="pl-5 flex">
            <GoGear className="mt-1 mx-1" />
            Service
          </NavLink>
          <NavLink to="/products" activeClassName="active" className="pl-5 flex">
            {" "}
            <FaOpencart className="mt-1 mx-1" />
            Products
          </NavLink>
          <NavLink to="/gallery" activeClassName="active" className="pl-5  flex">
            {" "}
            <IoImagesOutline className="mt-1 mx-1" /> Gallery
          </NavLink>
          <NavLink to="/quotations" activeClassName="active" className="pl-5 flex">
