...
const TopNavbar = () => {
  ...
  return (
    <div>
      ...
      {sideBar && (
        <div className="fixed top-0 right-0 left-full z-40 w-[50%] h-screen p-4 overflow-y-auto transition-transform -translate-x-full bg-white">
          <div className="flex justify-between items-center text-2xl h-16">
            <div>
              {" "}
