...
const TopNavbar = () => {
  ...
  return (
    <div>
      ...
      {sideBar && (
        <div className="fixed top-0 right-0 left-full z-40 w-[50%] h-screen overflow-y-auto transition-transform -translate-x-full bg-white/60  rounded-xl backdrop-sepia-0  backdrop-blur-sm drop-shadow-xl">
