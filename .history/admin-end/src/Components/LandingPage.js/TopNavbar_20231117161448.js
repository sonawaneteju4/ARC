...
const TopNavbar = () => {
  ...
  return (
    <div>
      ...
      {sideBar && (
        <div className="fixed top-0 right-0 left-full z-40 w-96 h-screen p-4 overflow-y-auto transition-transform -translate-x-full bg-white">
          <div className="flex justify-between text-5xl cursor-pointer" onClick={()=> setsideBar(false)}>
            <div>        <p>Current Sessions</p>
</div>
            <IoIosClose/>
            </div>
          <SideBar />
