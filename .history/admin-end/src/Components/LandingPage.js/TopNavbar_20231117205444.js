...
const TopNavbar = () => {
  ...
  return (
    <div>
      ...
      {sideBar && (
 <div className="fixed top-0 right-0 left-full z-40 w-[40%] h-screen p-4 overflow-y-auto bg-white
               transform translate-x-0 transition-transform">          <div className="flex justify-between items-center text-2xl ">
            <div>
              {" "}
              <p>Current Sessions</p>
            </div>
            <div className="text-4xl cursor-pointer">
              <IoIosClose onClick={() => setsideBar(false)} />
            </div>
          </div>
          <SideBar />
        </div>
