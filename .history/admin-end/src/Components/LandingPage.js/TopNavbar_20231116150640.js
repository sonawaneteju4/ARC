    ...
    <div>
      <div className=" w-screen h-16 bg-slate-100 flex justify-between">
        <div className=" flex items-center">
          ...
          <p className="pl-5 text-blue-400">Service</p>
          <p className="pl-5 text-blue-400">Products</p>
          <p className="pl-5 text-blue-400">Gallery</p>
          <p className="pl-5 text-blue-400">Quotations</p>
        </div>
