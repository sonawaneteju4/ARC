...
const OrderDash = () => {
  ...
  return (
    <>
      {/* Total Orders */}
      <div className="basis-1/4 bg-white/60 m-3 p-3 rounded-xl backdrop-sepia-0  backdrop-blur-sm drop-shadow-xl">
      ...
      {/*New Quotation */}
      <div className="basis-1/4 bg-white/60 backdrop-sepia-0  backdrop-blur-sm drop-shadow-xl m-3 p-3 rounded-xl">
        <div className="flex justify-center items-center h-10 w-10 rounded-full bg-blue-200 p-2 my-3 mx-5">
