      ...
      const fetchCartItems = async () => {
        ...
        try {
          const res = await fetch(
            "http://localhost:5000/api/cart/cartuser",
            {
              method: "GET",
              headers: {
      ...
      <div className="mt-20 min-h-screen divide-y-2">
        ...
        <div className="flex lg:flex-row md:flex-col max-sm:flex-col">
          <div className="basis-2/3 p-5 h-[75vh]  lg:scrollbar-thin scrollbar-thumb-sky-600 scrollbar-track-sky-300 overflow-y-scroll dark:scrollbar-thumb-blue-100 dark:scrollbar-track-gray-700 scrollbar-track-rounded-full">
            {fornew ? (
              <div className="flex flex-col items-center justify-center h-96 odd:bg-gray-100 even:bg-gray-300">
                <svg
              ...
              <div>
                {cartItems.length === 0 ? (
                  <div className="flex flex-col items-center justify-center h-96 odd:bg-gray-300 even:bg-teal-300p">
                    <svg
                      className="w-24 h-24 mb-4 animate-bounce text-gray-400"
                      fill="none"
                      stroke="currentColor"
                  ...
                  cartItems.map((item, index) => (
                    <>
                      ...
                      <div
                        key={item._id}
                        className="lg:flex lg:justify-between border-2 mt-2 p-2 rounded-xl  odd:bg-gray-100 even:bg-gray-300"
                      >
