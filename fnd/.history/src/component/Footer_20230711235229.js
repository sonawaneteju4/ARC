...
const Footer = () => {
  return (
    <div>
      <footer className="top-full bottom-0 left-0 w-full md:px-1 md:py-1 bg-black">
              ...
              <li className=" mx-3 hover:scale-125 ">
                ...
                >
                  <span className="text-2xl text-purple-400">
                    <BsInstagram className="hover:border-2" />
                  </span>
                </a>
              </li>
              <li className=" mx-3 hover:scale-125 ">
                ...
                >
                  <span className="text-2xl ">
                    <SiGooglemaps className="hover:border-2" />
                  </span>
                </a>
              </li>
              <li className=" mx-3 hover:scale-125 ">
                ...
                >
                  <span className="text-2xl text-green-700">
                    <FaWhatsapp className="hover:border-2" />
                  </span>
                </a>
              </li>
              <li className=" mx-3 hover:scale-125 ">
                <a href="tel:+9180087258100" className="mr-4 hover:underline">
                  <span className="text-2xl text-green-700">
                    <AiOutlinePhone className="hover:border-2" />
                  </span>
                </a>
              </li>
              <li className=" mx-3 hover:scale-125 ">
                <a href="tel:+9180087258100" className="mr-4 hover:underline">
                  <span className="text-2xl text-red-700">
                    <AiFillYoutube className="hover:border-2" />
                  </span>
                </a>
              </li>
            </ul>
      ...
      <span className="flex justify-center items-center p-1 text-sm text-white sm:text-center ">
        ...
        <span className="text-purple-500 fill-purple-500 px-2 text-xl">
          <AiOutlineHeart />
        </span>
      </span>
    </footer> */}
