...
const Index = () => {
  ...
  return (
    <div className="">
      {isLoading && <Spinner />}
      <div
        className=" lg:pt-10 pt-20  lg:pb-5 bg-auto "
        style={{ background: `url("/image/bgbackmain.png")` }}
      >
        <StoreFront />
      </div>
      <div className="bg-gradient-to-r from-slate-50 via-slate-100 to-slate-200">
        ...
        <div className="pb-5 bg-gradient-to-r from-slate-50 via-slate-100 to-slate-200 flex flex-row">
          <div className="basis-2/5 w-2/5 pb-5 pt-5 mx-5 pt-5 bg-gradient-to-r from-slate-50 via-slate-100 to-slate-200">
            <Revies />
          </div>
          <div className="basis-3/5 w-3/5 bg-white rounded-2xl mx-5 pt-5 pb-5">
            <GoogleReviews />
          </div>
        </div>
