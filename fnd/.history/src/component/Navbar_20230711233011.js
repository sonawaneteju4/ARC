...
const Navbar = () => {
  ...
  return (
    <>
      <nav
        className="flex justify-between  px-2 z-10  py-2.5 h-16 bg-black fixed w-full top-0 mt-0 z-10 "
      >
        ...
        {mobileDisplay ? (
          <>
            <div className="flex justify-center mt-5  overflow-x-hidden overflow-y-auto fixed inset-0 z-0 outline-none focus:outline-none">
              <div
