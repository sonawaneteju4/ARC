...
const API = "https://backend-production-30a4.up.railway.app/api/services/getservices";
...
const ServiceComp = () => {
  ...
  useEffect(() => {
    fetchApiData(`https://backend-production-30a4.up.railway.app/api/services/getservices?_id=${_id}`);
  }, [_id]);
