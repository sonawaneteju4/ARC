...
const Revies = () => {
  ...
  return (
    <>
      <div className="pt-5">
        <div>
          <p style={{color: "dodgerblue"}} className="font-bold text-3xl lg:text-5xl  text-center lg:mb-8 ">
            {" "}
            What Google Say About Us?
          </p>
          <div className="flex lg:grid-cols-2 sm:grid-cols-1  lg:gap-4 sm:gap-2 divide-gray-300">
