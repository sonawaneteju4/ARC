  ...
  return (
    <div>
         <div className="mt-5">
          ...
          <div className=' '><a target='_blank' href='https://g.page/r/CYIVN_GJEMY5EB0/review' className='px-7 mt-5 py-3 mr-2 bg-black text-white font-medium text-sm leading-snug uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-black active:shadow-lg transition duration-150 ease-in-out'>Add Review</a></div>
          </div>
        </div>
    </div>
  )
