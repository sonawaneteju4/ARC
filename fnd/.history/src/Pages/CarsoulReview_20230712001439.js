...
const user = [
  {review  :  4, content :"  Headlight tint to yellow Awesome work, other mods on process,pics soon uploaded" , user}
];
    ...
    <div>
      <div>
        ...
        >
          ...
          <div>
            <div className="flex justify-center lg:mx-5 mx-5">
              <div className="block p-6 rounded-lg shadow-lg bg-slate-200 max-w-sm">
                <h5 className="text-gray-900 text-xl leading-tight font-medium mb-2 flex justify-center">
                  <Box>
                    <Rating name="read-only" value={4} readOnly size="large" />
                  </Box>
