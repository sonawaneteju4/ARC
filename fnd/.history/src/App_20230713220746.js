...
const Navbar = () => {
  ...
  const isOnAdminHome = location.pathname === "/adminHome";

  if (isOnAdminHome) {
    return null; // Hide the Navbar on the adminHome route
  }

  return <div>Your Navbar component code here</div>;
};
...
function App() {
  ...
  return (
    ...
    >
      <BrowserRouter>
        <Navbar />
        <div style={{ backgroundColor: "#cce4f5;" }} className="">
          <Routes>
            ...
            <Route
              path="/"
              render={() => <Navbar />} // Render the Navbar component for other pages
            />
